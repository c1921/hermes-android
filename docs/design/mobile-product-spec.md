...
- Durable management destinations: Skills, Cron, Profiles, Providers, Files, Diagnostics, Messaging, MCP, Usage, Server Settings and Command Center. Artifacts join only when their backend paths are complete.
