...
| Messaging gateway | `gateway/run.py`, `gateway/platforms/`, `plugins/platforms/`, `gateway/session.py` | Asynchronous third-party messaging adapters and delivery. A platform adapter is not a full native-client contract. |
